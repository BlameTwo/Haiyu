...
{
    public partial class TwPGRGameViewModel : GameContextViewModelBase
    {
        public TwPGRGameViewModel(
            [FromKeyedServices(nameof(TwPGRGameContext))] IGameContext gameContext,
